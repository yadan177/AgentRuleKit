...
`0.1.0` 已完成首次公开发布；最新正式版本为 `0.1.2`。当前代码包含：
...
GitHub 仓库已公开；[`v0.1.2` GitHub Release](https://github.com/yadan177/AgentRuleKit/releases/tag/v0.1.2) 和 [npm CLI `agentrulekit@0.1.2`](https://www.npmjs.com/package/agentrulekit) 已发布。Go、TypeScript、Unity 临时工程已从 npm 安装本版 CLI 并通过公开 Release 的同版本验收；此前 `0.1.0 → 0.1.1` 的跨版本更新也已验收。Codex 桌面端插件交互与 Hook 实际调度仍待用户验收；非 Codex 自动生成器尚未实现。
